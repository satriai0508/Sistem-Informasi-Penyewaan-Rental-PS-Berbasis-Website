          ...
          <div class="row pb-4">
            <div class="col-12">
              <div class="input-group mb-3">
                ...
                <input id="email" type="email" name="email" class="form-control form-control-lg h-100 @error('email')
                                    is-invalid
              ...
              <div class="input-group mb-3">
                ...
                <input id="password" type="password" name="password" class="form-control form-control-lg h-100 @error('password')
                                is-invalid
